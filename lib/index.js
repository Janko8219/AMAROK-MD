...
const { amk1 } = require(__dirname + '/database/user');
const { amk } = require(__dirname + '/database/group');
...
module.exports = {
  ...
  AddMp3Meta: async (
    songbuffer,
    coverBuffer,
    options = { title: "Amarok-md Whatsapp bot", artist: ["Amarok"] }
  ) => {
